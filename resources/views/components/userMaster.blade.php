...
<head>
    ...
    <link rel="stylesheet" href="{{asset('admin/assets')}}/css/tooplate-main.css" />
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
        <div class="container">
            <a class="navbar-brand" href="{{url('/')}}"><img src="{{asset('admin/assets')}}/images/header-logo.png" alt="" /></a>
    ...
    <div class="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="logo">
                        <img src="{{asset('admin/assets')}}/images/header-logo.png" alt="" />
                    </div>
                </div>
                <div class="col-md-12">
