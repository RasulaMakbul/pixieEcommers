    ...
    <div class="featured container no-gutter">
        <div class="row posts">
            <div id="1" class="item new col-md-4">
                <a href="{{url('singleProduct')}}">
                    <div class="featured-item">
                        <img src="{{asset('admin/assets')}}/images/product-01.jpg" alt="" />
            ...
            <div id="2" class="item high col-md-4">
                <a href="{{url('singleProduct')}}">
                    <div class="featured-item">
                        <img src="{{asset('admin/assets')}}/images/product-02.jpg" alt="" />
            ...
            <div id="3" class="item low col-md-4">
                <a href="{{url('singleProduct')}}">
                    <div class="featured-item">
                        <img src="{{asset('admin/assets')}}/images/product-03.jpg" alt="" />
            ...
            <div id="4" class="item low col-md-4">
                <a href="{{url('singleProduct')}}">
                    <div class="featured-item">
                        <img src="{{asset('admin/assets')}}/images/product-04.jpg" alt="" />
            ...
            <div id="5" class="item new high col-md-4">
                <a href="{{url('singleProduct')}}">
                    <div class="featured-item">
                        <img src="{{asset('admin/assets')}}/images/product-05.jpg" alt="" />
                        <h4>Morbi aliquet</h4>
                        <h6>$55.00</h6>
                    </div>
                </a>
            ...
            <div id="6" class="item new col-md-4">
                <a href="{{url('singleProduct')}}">
                    <div class="featured-item">
                        <img src="{{asset('admin/assets')}}/images/product-06.jpg" alt="" />
                        <h4>Urna ac diam</h4>
                        <h6>$65.00</h6>
                    </div>
                </a>
