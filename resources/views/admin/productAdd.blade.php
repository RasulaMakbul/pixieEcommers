        ...
        <form>
            ...
            <form class="form-light">
                <div class="form-group col-8 m-3">
                    ...
                    <input type="text" class="form-control mt-2" id="exampleFormControlInput1" placeholder="Product Name">
                ...
                <div class="col-8 d-flex">
                    <div class="form-group col-6 m-3">
                        ...
                        <input type="text" class="form-control mt-2" id="exampleFormControlInput1" placeholder="Unit Price">
                    </div>
                    <div class="form-group col-5 m-3">
                        <label for="exampleFormControlInput1">Stock</label>
                        <input type="text" class="form-control mt-2" id="exampleFormControlInput1" placeholder="Stock">
                    </div>
                </div>
